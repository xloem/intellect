...
public:
	...
	void push_front(/*cut-short-in-middle error*//*later, discovered this was slightly wrong*/wrapped item)
	{
	...
	void push_back(/*cut-short-in-middle error*//*later, discovered this was slightly wrong*/wrapped item)
	{
		if (!this->get(sym::first)) {
			*(ref*)this += {
				{sym::first, item},
