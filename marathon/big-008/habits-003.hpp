...
namespace act {
	...
	cxxhabit call_while("callwhile", {sym::context}, {sym::habit, sym::what}, call_while_func);
	...
	void jump_func(ref);
	cxxhabit jump("jump",{},{sym::step},jump_func);
	...
	cxxhabit ifthenjump("ifthenjump", {},{sym::what,sym::step},ifthenjump_func);
	...
	cxxhabit whilesteps_gimmick("whilestepsgimmick", {sym::what},{sym::what,sym::steps/*seq*/},whilesteps_gimmick_func);
	...
	cxxhabit whilesteps("whilesteps",{},{sym::what,sym::steps},whilesteps_func);
	...
	void get_func(ref);
	cxxhabit get("get",{sym::to},{sym::from, sym::type},get_func);
	...
	void set_func(ref);
	cxxhabit set("set",{},{sym::from, sym::type, sym::to},set_func);
